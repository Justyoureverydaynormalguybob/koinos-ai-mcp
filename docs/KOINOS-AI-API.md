...
version **v0.21.2** (2026-08-15). Sources: `core/lib/gateway.js`, `core/server.js`,
`core/models/catalog.json`.
...
POST /core/models/import          import a user-supplied model file
     /core/models/custom/<id>     custom model detail
...
GET/POST /core/tasks              scheduled tasks
         /core/tasks/<id>
GET/POST /core/chats              chat history
         /core/chats/<id>          (DELETE also works — live-verified 2026-08-16,
                                   returns {ok:true}; not in the route summary upstream)
